-- =============================================================================
-- gerirfrota — dump.sql (instância JUREMA)
-- Seeds (lookups + IBGE) + entidade (Jurema) + usuário admin.
...
-- =============================================================================
-- ENTIDADE: Prefeitura Municipal de Jurema (IBGE 2205532)
-- =============================================================================
...
--   username: admin
--   senha:    035AHRSw?
--   (email interno; login é feito por username via RPC email_from_username)
-- =============================================================================
do $$
declare
  v_user_id  uuid := 'a0000000-0000-0000-0000-000000000001';
  v_email    text := 'admin@gerirfrota.local';
